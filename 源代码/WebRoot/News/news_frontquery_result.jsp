		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#newsListPanel" aria-controls="newsListPanel" role="tab" data-toggle="tab">新闻公告列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>News/news_frontAdd.jsp" style="display:none;">添加新闻公告</a></li>
				</ul>
			  	<!-- Tab panes -->
				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					<% 
				    	            		...
				    	            		for(int i=0;i<newsList.size();i++) {
					    	            		...
					    	            		News news = newsList.get(i); //获取到新闻公告对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
 											<td><%=news.getNewsId() %></td>
 											<td><%=news.getNewsType() %></td>
 											<td><%=news.getTitle() %></td>
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="news_newsId_edit" class="col-md-3 text-right">记录id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="news_newsId_edit" name="news.newsId" class="form-control" placeholder="请输入记录id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="news_title_edit" class="col-md-3 text-right">信息标题:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="news_title_edit" name="news.title" class="form-control" placeholder="请输入信息标题">
			 </div>
		  </div>
		  <div class="form-group">
