...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">驾校管理网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Coach/frontlist">教练风采</a></li>
                <li><a href="<%=basePath %>Car/frontlist">车辆安排</a></li>
                <!--<li><a href="<%=basePath %>Subject/frontlist">科目</a></li>-->
                <li><a href="<%=basePath %>Paper/frontlist">科目考试</a></li>
                <!--<li><a href="<%=basePath %>Answer/frontlist">学员答案</a></li>-->
                <li><a href="<%=basePath %>Leaveword/frontlist">学员留言</a></li>
                <li><a href="<%=basePath %>News/frontlist">新闻公告</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
				    ...
				    if(user_name==null){
	  			%> 
	  			<li><a href="<%=basePath %>UserInfo/userInfo_frontAdd.jsp"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;报名注册</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel"> 
                        <li><a href="<%=basePath %>Answer/userFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的成绩查询</a></li>
                        <li><a href="<%=basePath %>Leaveword/leaveword_userFrontAdd.jsp"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我要留言</a></li>
                        <li><a href="<%=basePath %>Leaveword/userFrontlist"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;我的留言</a></li>
