...
<div class="container">
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">车辆名称:</div>
		<div class="col-md-10 col-xs-6"><%=car.getCarName()%></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">换挡方式:</div>
		<div class="col-md-10 col-xs-6"><%=car.getShitWay()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">上牌日期:</div>
		<div class="col-md-10 col-xs-6"><%=car.getOnCardDate()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">车辆介绍:</div>
		<div class="col-md-10 col-xs-6"><%=car.getCarDesc()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">车辆状态:</div>
		<div class="col-md-10 col-xs-6"><%=car.getCarState().getStateName() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">训练场地:</div>
		<div class="col-md-10 col-xs-6"><%=car.getCarPlace()%></div>
	</div>
	<div class="row bottom15">
