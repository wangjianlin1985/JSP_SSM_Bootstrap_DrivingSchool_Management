		       ...
		       text: "车辆状态管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "CarState/carState_add.jsp"
			    	   	},
			    		{
			    	   		text: "车辆状态管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "CarState/carState_query_result.jsp"
			    	    }
			    	   ]
			},*/{
		       text: "科目试卷管理",
			       ...
			       children:
			    	   [{
			    	    ...
			    	    },
			    	    {
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Paper/paper_add.jsp"
			    	   	},
			    		{
			    	   		text: "考试试卷管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Paper/paper_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "学员答案管理",
