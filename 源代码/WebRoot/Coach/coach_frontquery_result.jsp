...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		...
		<div class="row">
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Coach/<%=coach.getCoachId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=coach.getCoachPhoto()%>" /></a>
			     <div class="showFields">
			        ...
			        <a class="btn btn-primary top5" href="<%=basePath %>Coach/<%=coach.getCoachId() %>/frontshow">详情</a>
			        <a class="btn btn-primary top5" onclick="coachEdit('<%=coach.getCoachId() %>');" style="display:none;">修改</a>
			        <a class="btn btn-primary top5" onclick="coachDelete('<%=coach.getCoachId() %>');" style="display:none;">删除</a>
			     </div>
			</div>
			<%  } %>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="coachQueryForm" id="coachQueryForm" action="<%=basePath %>Coach/frontlist" class="mar_t15">
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="coach_coachId_edit" class="col-md-3 text-right">教练id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="coach_coachId_edit" name="coach.coachId" class="form-control" placeholder="请输入教练id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="coach_sex_edit" class="col-md-3 text-right">性别:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="coach_sex_edit" name="coach.sex" class="form-control" placeholder="请输入性别">
			 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="coach_email_edit" class="col-md-3 text-right">邮箱:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="coach_email_edit" name="coach.email" class="form-control" placeholder="请输入邮箱">
			 </div>
		  </div>
		  <div class="form-group">
...
/*弹出修改教练界面并初始化数据*/
function coachEdit(coachId) {
	$.ajax({
		url :  basePath + "Coach/" + coachId + "/update",
		type : "get",
		dataType: "json",
		success : function (coach, response, status) {
			if (coach) {
				$("#coach_coachId_edit").val(coach.coachId);
				$("#coach_name_edit").val(coach.name);
				$("#coach_sex_edit").val(coach.sex);
				...
				$("#coach_email_edit").val(coach.email);
...
function ajaxCoachModify() {
	$.ajax({
		url :  basePath + "Coach/" + $("#coach_coachId_edit").val() + "/update",
		type : "post",
		dataType: "json",
