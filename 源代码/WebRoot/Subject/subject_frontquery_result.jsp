...
<jsp:include page="../header.jsp"></jsp:include>
		...
		<div class="col-md-12 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#subjectListPanel" aria-controls="subjectListPanel" role="tab" data-toggle="tab">科目列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>Subject/subject_frontAdd.jsp" style="display:none;">添加科目</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>科目名称</td><td>适用车辆</td><td>驾照级别</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<subjectList.size();i++) {
					    	            		...
					    	            		Subject subject = subjectList.get(i); //获取到科目对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
 											<td><%=subject.getSubjectName() %></td>
 											<td><%=subject.getCarType() %></td>
 											<td><%=subject.getDriveLevel() %></td>
 											<td>
	...
	<div style="display:none;">
		...
		<form name="subjectQueryForm" id="subjectQueryForm" action="<%=basePath %>Subject/frontlist" class="mar_t15">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;科目信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="subject_subjectId_edit" class="col-md-3 text-right">科目id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="subject_subjectId_edit" name="subject.subjectId" class="form-control" placeholder="请输入科目id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="subject_subjectName_edit" class="col-md-3 text-right">科目名称:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="subject_subjectName_edit" name="subject.subjectName" class="form-control" placeholder="请输入科目名称">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="subject_carType_edit" class="col-md-3 text-right">适用车辆:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="subject_carType_edit" name="subject.carType" class="form-control" placeholder="请输入适用车辆">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="subject_driveLevel_edit" class="col-md-3 text-right">驾照级别:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="subject_driveLevel_edit" name="subject.driveLevel" class="form-control" placeholder="请输入驾照级别">
			 </div>
		  </div>
		</form> 
	...
	$.ajax({
		...
		success : function (subject, response, status) {
			if (subject) {
				...
				$("#subject_carType_edit").val(subject.carType);
				$("#subject_driveLevel_edit").val(subject.driveLevel);
