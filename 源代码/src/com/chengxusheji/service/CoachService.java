...
public class CoachService {
    ...
    /*按照查询条件分页查询教练记录*/
    public ArrayList<Coach> queryCoach(String name,String birthDate,String telephone,int currentPage) throws Exception { 
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Coach> queryCoach(String name,String birthDate,String telephone) throws Exception  { 
     	String where = "where 1=1";
    	if(!name.equals("")) where = where + " and t_coach.name like '%" + name + "%'";
    	if(!birthDate.equals("")) where = where + " and t_coach.birthDate like '%" + birthDate + "%'";
    	if(!telephone.equals("")) where = where + " and t_coach.telephone like '%" + telephone + "%'";
    ...
    /*根据主键获取教练记录*/
    public Coach getCoach(int coachId) throws Exception  {
        Coach coach = coachMapper.getCoach(coachId);
        return coach;
    }
    ...
    /*删除多条教练信息*/
    public int deleteCoachs (String coachIds) throws Exception {
    	String _coachIds[] = coachIds.split(",");
    	for(String _coachId: _coachIds) {
    		coachMapper.deleteCoach(Integer.parseInt(_coachId));
    	}
    	return _coachIds.length;
    }
}
